...
public class MoveBackAndForth : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        foreach(GameObject myObject in ObjectsToMove)
        {
           startPositions.Add(myObject.transform.position); // one of these lists needs this kind of position...
           endPositions.Add(myObject.transform.position + new Vector3(0,0,10f)); // another one needs another...
        }
    }
